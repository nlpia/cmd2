...
class CmdLineApp(cmd2.Cmd):
    ...
    def __init__(self):
        with open(os.path.join(cmd2.constants.BASE_DIR, 'data', 'aliases.yml'), 'r') as fin:
            shortcuts = yaml.load(fin)
        print(f"Loading shortcuts: {shortcuts}")
        ...
        self._set_prompt()
        self.intro = 'Welcome to your shell assistant.'
        self.default_to_shell = True
        self.locals_in_py = True  # any script launched by the pyscript command will have access to self
